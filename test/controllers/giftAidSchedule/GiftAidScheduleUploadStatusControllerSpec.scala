...
class GiftAidScheduleUploadStatusControllerSpec extends ControllerSpec {
  ...
  "GiftAidScheduleUploadStatusControllerSpec" - {
      ...
      "unsubmitted Claim ID is not defined" in {
        ...
        running(application) {
          val request: FakeRequest[AnyContentAsEmpty.type] =
            FakeRequest(GET, routes.GiftAidScheduleUploadStatusController.status.url)
