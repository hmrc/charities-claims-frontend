...
class ConnectedCharitiesScheduleUploadStatusControllerSpec extends ControllerSpec {
  ...
  lazy val testAwaitingResponse: GetUploadResultAwaitingUpload =
    readJson("/test-get-upload-result-awaiting-upload-connected-charities.json").as[GetUploadResultAwaitingUpload]

  lazy val testVerifyingResponse: GetUploadResultVeryfying =
    readJson("/test-get-upload-result-verifying-connected-charities.json").as[GetUploadResultVeryfying]

  lazy val testValidatingResponse: GetUploadResultValidating =
    readJson("/test-get-upload-result-validating-connected-charities.json").as[GetUploadResultValidating]
      ...
      "unsubmitted Claim ID is defined and file reference is not defined" in {
        val sessionData =
          completeRepaymentDetailsAnswersSession
            ...
            .copy(connectedCharitiesScheduleFileUploadReference = None)
