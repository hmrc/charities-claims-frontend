...
class ProblemUpdatingConnectedCharitiesScheduleUnknownErrorControllerSpec extends ControllerSpec {

  "ProblemUpdatingConnectedCharitiesScheduleUnknownErrorController" - {
    "onPageLoad" - {
      "should render the page correctly" in {
        ...
        running(application) {
          val request: FakeRequest[AnyContentAsEmpty.type] =
            FakeRequest(GET, routes.ProblemUpdatingConnectedCharitiesScheduleUnknownErrorController.onPageLoad.url)
