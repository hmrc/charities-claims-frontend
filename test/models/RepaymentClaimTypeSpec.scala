...
class RepaymentClaimTypeSpec extends BaseSpec {
  ...
  "RepaymentClaimType" - {
    "be serializable and deserializable" in {
      ...
      val json                           = Json.toJson(repaymentClaimType)
      val deserializedRepaymentClaimType = json.as[RepaymentClaimType]
      deserializedRepaymentClaimType shouldBe repaymentClaimType
    }
  }
}
