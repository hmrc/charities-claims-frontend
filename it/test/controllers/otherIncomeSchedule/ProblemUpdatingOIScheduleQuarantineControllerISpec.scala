...
class ProblemUpdatingOIScheduleQuarantineControllerISpec
  extends ComponentSpecHelper with TestDataUtils
    with ClaimsStub
    with AuthStub
    with ClaimsValidationStub {

  private val url = "/problem-uploading-other-income-schedule-quarantine"

  "GET /problem-uploading-other-income-schedule-quarantine" should {
