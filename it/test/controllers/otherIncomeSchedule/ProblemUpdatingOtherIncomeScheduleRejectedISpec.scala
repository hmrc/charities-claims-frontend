...
class ProblemUpdatingOtherIncomeScheduleRejectedISpec
  extends ComponentSpecHelper with TestDataUtils
    with ClaimsStub
    with AuthStub
    with ClaimsValidationStub {

  private val url = "/problem-uploading-other-income-schedule-rejected"

  "GET /problem-uploading-other-income-schedule-rejected" should {
    ...
    "render the rejected failure page" in {
      ...
      doc.title should include(msg("problemUpdatingOtherIncomeScheduleRejected.title"))
    }
  }

  "POST /problem-uploading-other-income-schedule-rejected" should {
