...
class ProblemUpdatingOtherIncomeScheduleUnknownErrorISpec
  extends ComponentSpecHelper with TestDataUtils
    with ClaimsStub
    with AuthStub
    with ClaimsValidationStub {

  private val url = "/problem-uploading-other-income-schedule-unknown-error"

  "GET /problem-uploading-other-income-schedule-unknown-error" should {
    ...
    "render the unknown error page" in {
      ...
      doc.title should include(msg("problemUpdatingOtherIncomeScheduleUnknownError.title"))
    }
  }

  "POST /problem-uploading-other-income-schedule-unknown-error" should {
