...
class ProblemUpdatingGiftAidScheduleUnknownErrorISpec
  extends ComponentSpecHelper with TestDataUtils
    with ClaimsStub
    with AuthStub
    with ClaimsValidationStub {

  private val url = "/problem-uploading-gift-aid-schedule-unknown-error"

  "GET /problem-uploading-gift-aid-schedule-unknown-error" should {
    ...
    "render the unknown error page" in {
      ...
      doc.title should include(msg("problemUpdatingGiftAidScheduleUnknownError.title"))
    }
  }

  "POST /problem-uploading-gift-aid-schedule-unknown-error" should {
