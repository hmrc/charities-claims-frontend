...
class ProblemUpdatingGiftAidScheduleRejectedISpec
  extends ComponentSpecHelper with TestDataUtils
    with ClaimsStub
    with AuthStub
    with ClaimsValidationStub {

  private val url = "/problem-uploading-gift-aid-schedule-rejected"

  "GET /problem-uploading-gift-aid-schedule-rejected" should {
    ...
    "render the rejected failure page" in {
      ...
      doc.title should include(msg("problemUpdatingGiftAidScheduleRejected.title"))
    }
  }

  "POST /problem-uploading-gift-aid-schedule-rejected" should {
