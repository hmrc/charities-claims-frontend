...
class ProblemUpdatingCommunityBuildingsScheduleUnknownErrorISpec
  extends ComponentSpecHelper with TestDataUtils
    with ClaimsStub
    with AuthStub
    with ClaimsValidationStub {

  private val url = "/problem-uploading-community-buildings-schedule-unknown-error"

  "GET /problem-uploading-community-buildings-schedule-unknown-error" should {
    ...
    "render the unknown error page" in {
      ...
      doc.title should include(msg("problemUpdatingCommunityBuildingsScheduleUnknownError.title"))
    }
  }

  "POST /problem-uploading-community-buildings-schedule-unknown-error" should {
