...
class ProblemUpdatingCBScheduleQuarantineControllerISpec
  extends ComponentSpecHelper with TestDataUtils
    with ClaimsStub
    with AuthStub
    with ClaimsValidationStub {

  private val url = "/problem-uploading-community-buildings-schedule-quarantine"

  "GET /problem-uploading-community-buildings-schedule-quarantine" should {
    ...
    "render the quarantine failure page" in {
      ...
      doc.title should include(msg("problemUpdatingCommunityBuildingsScheduleQuarantine.title"))
    }
    ...
    "render the agent quarantine failure page" in {
      ...
      val doc = Jsoup.parse(result.body)
      doc.title should include(msg("problemUpdatingCommunityBuildingsScheduleQuarantine.agent.title"))
    }
  }

  "POST /problem-uploading-community-buildings-schedule-quarantine" should {
