...
class ProblemUpdatingConnectedCharitiesScheduleRejectedISpec
  extends ComponentSpecHelper with TestDataUtils
    with ClaimsStub
    with AuthStub
    with ClaimsValidationStub {

  private val url = "/problem-uploading-connected-charities-schedule-rejected"

  "GET /problem-uploading-connected-charities-schedule-rejected" should {
    ...
    "render the rejected failure page" in {
      ...
      doc.title should include(msg("problemUpdatingConnectedCharitiesScheduleRejected.title"))
    }
  }

  "POST /problem-uploading-connected-charities-schedule-rejected" should {
