...
class ProblemUpdatingConnectedCharitiesScheduleUnknownErrorISpec
  extends ComponentSpecHelper with TestDataUtils
    with ClaimsStub
    with AuthStub
    with ClaimsValidationStub {

  private val url = "/problem-uploading-connected-charities-schedule-unknown-error"

  "GET /problem-uploading-connected-charities-schedule-unknown-error" should {

    "render the unknown error page" in {
      stubBackend()
      ...
      doc.title should include(msg("problemUpdatingConnectedCharitiesScheduleUnknownError.title"))
    }
  }

  "POST /problem-uploading-connected-charities-schedule-unknown-error" should {
